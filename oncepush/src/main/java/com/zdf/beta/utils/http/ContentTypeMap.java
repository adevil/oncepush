...
public class ContentTypeMap {
    ...
    public static final Map<String, String> CONTENT_TYPE_TO_EXT = new HashMap<String, String>() {
        {
    ...
    public static final Map<String, String> EXT_TO_CONTENT_TYPE = new HashMap<String, String>() {
        {
